/****************************************************************************
** Meta object code from reading C++ file 'TestOpenGl.h'
**
...
#include "../../../../../ThirdParty/testOpenGl/TestOpenGl.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'TestOpenGl.h' doesn't include <QObject>."
...
struct qt_meta_stringdata_TestOpenGl_t {
    QByteArrayData data[1];
    char stringdata0[11];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_TestOpenGl_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_TestOpenGl_t qt_meta_stringdata_TestOpenGl = {
    {
QT_MOC_LITERAL(0, 0, 10) // "TestOpenGl"
...
static const uint qt_meta_data_TestOpenGl[] = {
...
void TestOpenGl::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
QT_INIT_METAOBJECT const QMetaObject TestOpenGl::staticMetaObject = { {
    &QMainWindow::staticMetaObject,
    qt_meta_stringdata_TestOpenGl.data,
    qt_meta_data_TestOpenGl,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
const QMetaObject *TestOpenGl::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *TestOpenGl::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_TestOpenGl.stringdata0))
        return static_cast<void*>(this);
    return QMainWindow::qt_metacast(_clname);
}

int TestOpenGl::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
